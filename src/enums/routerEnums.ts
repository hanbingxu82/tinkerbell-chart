...
export const ErrorPageNameMap = new Map([
  [ResultEnum.NOT_FOUND, RouterEnum.ERROR_PAGE_NAME_404],
  [ResultEnum.SERVER_FORBIDDEN, RouterEnum.ERROR_PAGE_NAME_403],
  [ResultEnum.SERVER_ERROR, RouterEnum.ERROR_PAGE_NAME_500]
])
